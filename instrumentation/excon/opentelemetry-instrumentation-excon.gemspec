...
require 'opentelemetry/instrumentation/excon/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-excon'
  spec.version     = OpenTelemetry::Instrumentation::Excon::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Excon instrumentation for the OpenTelemetry framework'
  spec.description = 'Excon instrumentation for the OpenTelemetry framework'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/excon'
