...
Gem::Specification.new do |spec|
  ...
  spec.add_dependency 'opentelemetry-instrumentation-active_model_serializers', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-concurrent_ruby', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-dalli', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-delayed_job', '~> 0.15.0'
  ...
  spec.add_dependency 'opentelemetry-instrumentation-lmdb', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-mongo', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-mysql2', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-net_http', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-rack', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-rails', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-redis', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-restclient', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-ruby_kafka', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-sidekiq', '~> 0.15.0'
  spec.add_dependency 'opentelemetry-instrumentation-sinatra', '~> 0.15.0'
