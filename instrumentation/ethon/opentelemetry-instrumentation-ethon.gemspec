...
require 'opentelemetry/instrumentation/ethon/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-ethon'
  spec.version     = OpenTelemetry::Instrumentation::Ethon::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Ethon instrumentation for the OpenTelemetry framework'
  spec.description = 'Ethon instrumentation for the OpenTelemetry framework'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/ethon'
