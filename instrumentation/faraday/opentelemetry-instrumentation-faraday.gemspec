...
require 'opentelemetry/instrumentation/faraday/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-faraday'
  spec.version     = OpenTelemetry::Instrumentation::Faraday::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Faraday instrumentation for the OpenTelemetry framework'
  spec.description = 'Faraday instrumentation for the OpenTelemetry framework'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/faraday'
