...
require 'opentelemetry/instrumentation/sidekiq/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-sidekiq'
  spec.version     = OpenTelemetry::Instrumentation::Sidekiq::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Sidekiq instrumentation for the OpenTelemetry framework'
  spec.description = 'Sidekiq instrumentation for the OpenTelemetry framework'
  ...
  spec.add_development_dependency 'sidekiq', '~> 5.0.0'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/sidekiq'
