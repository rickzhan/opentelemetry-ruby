...
require 'opentelemetry/instrumentation/mongo/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-mongo'
  spec.version     = OpenTelemetry::Instrumentation::Mongo::VERSION
