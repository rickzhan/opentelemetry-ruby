...
require 'opentelemetry/instrumentation/dalli/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-dalli'
  spec.version     = OpenTelemetry::Instrumentation::Dalli::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Dalli instrumentation for the OpenTelemetry framework'
  spec.description = 'Dalli instrumentation for the OpenTelemetry framework'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/dalli'
