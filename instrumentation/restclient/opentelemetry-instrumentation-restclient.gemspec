...
require 'opentelemetry/instrumentation/restclient/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-instrumentation-restclient'
  spec.version     = OpenTelemetry::Instrumentation::RestClient::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'REST Client instrumentation for the OpenTelemetry framework'
  spec.description = 'REST Client instrumentation for the OpenTelemetry framework'
  ...
  if spec.respond_to?(:metadata)
    ...
    spec.metadata['source_code_uri'] = 'https://github.com/open-telemetry/opentelemetry-ruby/tree/main/instrumentation/restclient'
