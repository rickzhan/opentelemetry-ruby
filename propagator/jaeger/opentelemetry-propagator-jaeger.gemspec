...
require 'opentelemetry/propagator/jaeger/version'

Gem::Specification.new do |spec|
  spec.name        = 'opentelemetry-propagator-jaeger'
  spec.version     = OpenTelemetry::Propagator::Jaeger::VERSION
  spec.authors     = ['OpenTelemetry Authors']
  spec.email       = ['cncf-opentelemetry-contributors@lists.cncf.io']

  spec.summary     = 'Jaeger Context Propagation Extension for the OpenTelemetry framework'
  spec.description = 'Jaeger Context Propagation Extension for the OpenTelemetry framework'
  ...
  spec.add_development_dependency 'opentelemetry-sdk', '~> 0.14.0'
